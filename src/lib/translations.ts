export const translations = {
  ru: {
    ...
    features: {
      ...
      subtitle: 'Современные технологии ИИ для автоматизации документирования, визуализации требований и ускорения рутинных процессов прямо <br />в VS Code/Cursor/WindSurf',
      llmChoice: {
