      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            How to <span className="text-gradient">Start?</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          <Card className="p-6 shadow-card bg-card/50 backdrop-blur-sm border border-border/50 hover:shadow-glow transition-smooth group">
            ...
            <p className="text-muted-foreground mb-6">
              Watch our comprehensive video guide to get started with AI IDE BAS quickly and efficiently.
            </p>
          ...
          <Card className="p-6 shadow-card bg-card/50 backdrop-blur-sm border border-border/50 hover:shadow-glow transition-smooth group">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-xl font-semibold">Text Tutorial</h3>
            </div>
            <p className="text-muted-foreground mb-6">
              Follow our step-by-step written guide for detailed installation and configuration instructions.
            </p>
            <Button variant="outline" className="w-full group">
        ...
        <div className="text-center">
          ...
          <div className="mt-12">
            <h3 className="text-xl font-semibold mb-6">Need help with setup?</h3>
            <p className="text-muted-foreground mb-6">
              You can contact us through our social networks.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button variant="feature" size="lg" className="group">
