  ...
  ru: {
    ...
    getStarted: {
      ...
      textTutorial: {
        ...
        description: 'Следуйте нашему пошаговому письменному руководству с подробными инструкциями по установке и настройке.',
        button: 'Читать текстовый урок'
      },
      install: 'Установить AI IDE BAS',
  ...
  en: {
    ...
    modes: {
      ...
      projectManagerFeatures: [
        ...
        'Task assignment for development',
        'Task prioritization',
